...
static char *send_oscam_status(struct templatevars *vars, struct uriparams *params, int32_t apicall) {
	...
	char picon_name[32];
	tpl_printf(vars, TPLADD, "SVNREV", "8901");
	...
	if (picon_exists(picon_name)) {
		...
		tpl_printf(vars, TPLADD, "OSCAMLOGO", "<div class=\"oscamlogo\"><a class=\"oscamlogo\" href=\"http://www.streamboard.tv/oscam/timeline\">Oscam&nbsp;r%s</a></div>", "8901");
	}
